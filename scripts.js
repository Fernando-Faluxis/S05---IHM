...
function reservarArmario() {
  ...
  armarioEmprestado.dataReserva = dataReserva.toLocaleString(); //toLocalDateString formata a data e hora e deixa legivel

  //Calculando a data de entrega (24h depois)
